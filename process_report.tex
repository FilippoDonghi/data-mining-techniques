...
23 April 2026 & Built the feature engineering pipeline and trained the popularity baseline and LightGBM LambdaMART model. \\
23 April 2026 & Evaluated NDCG@5 on a search-level validation split, then added fairness auditing and family-query reweighting. \\
23 April 2026 & Wrote the report in LNCS format, generated figures and metrics from the pipeline, and validated the LaTeX build. \\
\bottomrule
\end{tabular}
\end{table}
